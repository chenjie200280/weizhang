...
import com.ttsofts.utils.GdtAdvertUtil;

public class MainActivity extends Activity {


	private String defaultChepai = "鄂"; // 粤=广东
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		gdtAdvertUtil = new GdtAdvertUtil(this);

		gdtAdvertUtil.loadBannerAd((ViewGroup) findViewById(R.id.mainAdView));
		gdtAdvertUtil.loadInterstitialAd();
		...
		weizhangIntent.putExtra("appId",1182);// 您的appId
		weizhangIntent.putExtra("appKey", "d50ae62e54948430a4f18861efa192fb");// 您的appKey
